...
const french = {
  ...
  trigrams: {
    ...
    'lle': 0.49, 'ait': 0.48, 'eur': 0.47, 'pre': 0.46, 'ver': 0.45,
    'ssi': 0.44, 'pro': 0.43, 'mai': 0.42, 'enc': 0.41, 'esse': 0.40,
    'nce': 0.39, 'ens': 0.38, 'air': 0.37, 'ont': 0.36, 'eme': 0.35,
    'ett': 0.34, 'tion': 0.33, 'uer': 0.32, 'elle': 0.31, 'ten': 0.30
  }
};
...
const spanish = {
  ...
  trigrams: {
    ...
    'cion': 0.39, 'des': 0.38, 'ado': 0.37, 'sta': 0.36, 'nte': 0.35,
    'ara': 0.34, 'ere': 0.33, 'ado': 0.32, 'ros': 0.31, 'com': 0.30,
    'res': 0.29, 'tar': 0.28, 'tra': 0.27, 'era': 0.26, 'una': 0.25,
    'tad': 0.24, 'aba': 0.23, 'ada': 0.22, 'ora': 0.21, 'ias': 0.20,
    'pre': 0.19, 'nci': 0.18, 'per': 0.17, 'ica': 0.16, 'men': 0.15,
    'ido': 0.14, 'ter': 0.13, 'ita': 0.12, 'ant': 0.11, 'enc': 0.10,
    'ndo': 0.09, 'pro': 0.08, 'era': 0.07, 'ier': 0.06, 'ien': 0.05,
    'ran': 0.04, 'ido': 0.03, 'cia': 0.02, 'nta': 0.01, 'mie': 0.01
  }
};
...
const german = {
  ...
  digrams: {
    ...
    'on': 0.76, 'as': 0.74, 'wi': 0.72, 'en': 0.70, 'rg': 0.68
  },
  ...
  trigrams: {
    ...
    'ens': 0.36, 'nge': 0.35, 'nden': 0.16, 'isch': 0.15, 'iche': 0.15,
    'lich': 0.14, 'ren': 0.13, 'eit': 0.12, 'ung': 0.11, 'hen': 0.10,
    'ich': 0.09, 'ach': 0.08, 'aus': 0.07, 'ben': 0.06, 'auf': 0.05,
    'ien': 0.04, 'man': 0.03, 'sei': 0.02, 'auch': 0.01, 'abe': 0.01,
    'ste': 0.01, 'bes': 0.01, 'ell': 0.01, 'wei': 0.01, 'war': 0.01
  }
};
